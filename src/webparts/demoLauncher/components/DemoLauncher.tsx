...
import styles from './DemoLauncher.module.scss';
...
export default class DemoLauncher extends React.Component<IDemoLauncherProps> {
  public render(): React.ReactElement<IDemoLauncherProps> {
    const {
      description,
      isDarkTheme,
      environmentMessage,
    ...
    return (
      <section className={`${styles.demoLauncher}`}>
